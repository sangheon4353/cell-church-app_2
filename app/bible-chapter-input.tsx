...
const styles = StyleSheet.create({
  ...
  assignmentLabel: { fontSize: 11, fontWeight: "600", textTransform: "uppercase", letterSpacing: 0.5 },
  assignmentBook: { fontSize: 20, fontWeight: "700" },
  assignmentChapters: { fontSize: 13 },
  dateRow: {
    flexDirection: "row",
    justifyContent: "space-between",
    alignItems: "center",
